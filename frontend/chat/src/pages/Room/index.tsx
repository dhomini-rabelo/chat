...
export function Room() {
    return (
        <Div.container className="min-h-screen mx-auto flex flex-col items-center justify-between">
            ...
            <div id="messages-container" className="grow my-3 w-full flex flex-col justify-end">
