            ...
            <div className="pt-6">
                <Div.chat className="flex items-center justify-between py-3">
                    ...
                    <div className="flex flex-col items-end">
                        ...
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M9.70707 5.29289L15.7071 11.2929C16.0976 11.6834 16.0976 12.3166 15.7071 12.7071L9.70707 18.7071C9.31657 19.0976 8.68338 19.0976 8.29287 18.7071C7.90237 18.3166 7.90237 17.6834 8.29287 17.2929L13.5858 12L8.29287 6.70711C7.90237 6.31658 7.90237 5.68342 8.29287 5.29289C8.68338 4.90237 9.31657 4.90237 9.70707 5.29289Z" fill="#243443"/></svg>
                    </div>
                </Div.chat>
                <Div.chat className="flex items-center justify-between py-3">
                    <div className="rounded-full h-12 w-12 bg-pBlue-300"></div>
