...
import { ChatCircleDots, ChatsCircle, PencilSimple, SignIn, User } from 'phosphor-react';
            ...
            <div className="w-full self-center grow mt-16">
                ...
                <div className="flex flex-col items-center">
                    <div className="relative img-container flex flex-col items-center justify-center rounded-full h-48 w-48 bg-pGray-300 mb-5">
                        <User size={48} />
                        <span className="absolute bottom-0 right-0 rounded-full bg-pBlue-300 h-12 w-12 flex flex-col items-center justify-center text-pGray-100"><PencilSimple size={24} /></span>
                    </div>
                    <ButtonForm>
                        <span>
